...
<div class="w3layouts-main">
	<h2>Đăng kí tài khoản</h2>
		<form action="register" method="POST">
            ...
            <input type="password" class="ggg" name="password_confirmation" placeholder="PASSWORD CONFIRM" required="">
			<h4><input type="checkbox" />Tôi đồng ý với các điểu khoản        <a href="{{url('rules')}}"><Điều khoản></a></h4>
			
				<div class="clearfix"></div>
				<input type="submit" value="Đăng kí">
		</form>
		<p>Đã có tài khoản.<a href="{{url('login')}}">Login</a></p>
</div>
</div>
