                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.html"><img src="{{asset('frontend/images/logo/4.png')}}" alt="logo images" style="max-width: 50%"></a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="ht__testimonial__activation clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 single__tes">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('frontend/images/test/client/1.png')}}" alt="testimonial images">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 single__tes">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('frontend/images/test/client/2.png')}}" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
